...
export OUTPUT_DIR="/home/work/MMSearch/svg-shared-model-new-copy/ai-search/lora/trained-lora-multiview-stage1-r1024"
export WANDB_PROJECT=finetune-multiview
export WANDB_NAME=run_multiview_stage1
