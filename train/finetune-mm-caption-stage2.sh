...
export OUTPUT_DIR="/home/work/MMSearch/svg-shared-model-new-copy/ai-search/lora/trained-lora-multiview-caption-stage2"
export RESUME_LORA="/home/work/MMSearch/svg-shared-model-new-copy/ai-search/lora/trained-lora-multiview-caption-stage1-r1024"
export WANDB_PROJECT=finetune-multiview
export WANDB_NAME=run_multiview_caption_stage2
